...
# Aliases
alias avd='emulator -avd Pixel_6_API_34' # Adjust the AVD name as needed
alias sdk='cd "$ANDROID_HOME"'           # Shortcut to navigate to the Android SDK directory

# Optional: direct sdkmanager command
...
# opencode
export PATH=/home/sabi-ur-rehman/.opencode/bin:$PATH
